    ...
    const fetchTableOrders = async () => {
      try {
        ...
        if (tableId) {
          ...
          // Handle new response structure with kotItems and completedOrders
          const data = response.data;
          
          if (data.kotItems && Array.isArray(data.kotItems)) {
            // New structure: use kotItems (active KOT orders)
            setTableOrders(data.kotItems);
          } else if (Array.isArray(data)) {
            // Old structure: direct array
            setTableOrders(data);
          } else if (data.items && Array.isArray(data.items)) {
            // Fallback: use items array
          ...
          console.log("Fetched table orders:", data);
        }
      } catch (error) {
